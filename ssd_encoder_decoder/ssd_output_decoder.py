...
def decode_detections(y_pred,priors,variances,
    ...
    if input_coords == 'centroids':
        y_pred_decoded_raw[:,:,[-2,-1]] = np.exp(y_pred_decoded_raw[:,:,[-2,-1]] * variances[[2,3]]) * priors[:,[-2,-1]]
        y_pred_decoded_raw[:,:,[-4,-3]] *= priors[:,[-2,-1]] * variances[[0,1]]
        y_pred_decoded_raw[:,:,[-4,-3]] += priors[:,[-4,-3]]
